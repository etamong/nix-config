...
ln -s $SOURCE_ROOT/home/.config/home-manager $HOME/.config/home-manager

# Link nix configuration
ln -s $SOURCE_ROOT/home/.config/nix $HOME/.config/nix
...
ln -s $SOURCE_ROOT/home/.p10k.zsh $HOME/.p10k.zsh

echo "Linked configurations:"
echo "ls -alh $HOME/.config"
ls -alh $HOME/.config
echo
echo "ls -alh $HOME"
ls -alh $HOME
